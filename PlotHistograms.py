...
TFileMCName = "/sps/lhcb/volle/MCsignal.root"
TFileDataName = "/data/lhcb/marin/lb2pkgamma/Data/2012/2hG-S21/radiative2hG_R14S21_MagUp_tmp.root"
MCTreeName = "DecayTree"
DataTreeName = "pkGTuple/DecayTree"


CutMC = TCut("pplus_ProbNNp>0.2 && Kminus_ProbNNk>0.2 && B_PT>4000 && Lambda_1520_0_PT>1500 && gamma_PT>3000 && pplus_PT>1000 && B_FDCHI2_OWNPV>100 && pplus_IPCHI2_OWNPV>50 && Kminus_IPCHI2_OWNPV>40")
...
def setupHistograms():
    histograms = [
        ...
        #["Lambda_1520_0_PT","P_{T}(#Lambda(1520))","Entries / {MeV}","Lambda_1520_0_PT>>h(100,1000,10000)"],
        ...
        ["Lambda_1520_0_eta","#eta(#Lambda(1520))","Entries / {}","(atanh(Lambda_1520_0_PZ/Lambda_1520_0_P))>>h(100,1.5,5)"],
        ["B_FDCHI2_OWNPV","#chi^{2}_{FD}(#Lambda_{b})","Entries / {}","B_FDCHI2_OWNPV>>h(100,0,2000)"],
        ["Lambda_1520_0_FDCHI2_OWNPV","#chi^{2}_{FD}(#Lambda(1520))","Entries / {}","Lambda_1520_0_FDCHI2_OWNPV>>h(100,0,2000)"],
        ...
        ["Lambda_1520_0_IPCHI2_OWNPV","#chi^{2}_{IP}(#Lambda(1520))","Entries / {}","Lambda_1520_0_IPCHI2_OWNPV>>h(100,0,1000)"],
        ["B_IPCHI2_OWNPV","#chi^{2}_{IP}(#Lambda_{b})","Entries / {}","B_IPCHI2_OWNPV>>h(100,0,10)"],
        #["Lambda_1520_0_OWNPV_CHI2","#chi^{2}_{vertex}(#Lambda(1520))","Entries / {}","Lambda_1520_0_OWNPV_CHI2>>h(100,0,90)"],
        ...
        #["Lambda_1520_0_DIRA_OWNPV","DIRA(#Lambda(1520))","Entries / {}","Lambda_1520_0_DIRA_OWNPV>>h(100,0.99,1.004)"],
